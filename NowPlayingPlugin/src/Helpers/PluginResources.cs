namespace Loupedeck.NowPlayingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.NowPlayingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.NowPlayingPlugin.Resources.Resource.txt`.
